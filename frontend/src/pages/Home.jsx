    ...
    <>
          ...
          <div className="row">
            <div className="col-3">
              <div className="famous-card position-relative bg-dark">
                <img src="images/smartwatch.png" className="img-fluid" alt="" />
      ...
      <section className="blog-wrapper py-5 home-wrapper-2">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
              <h3 className="section-heading">Our Lates Blogs</h3>
            </div>
            <BlogCard />
            <BlogCard />
            <BlogCard />
