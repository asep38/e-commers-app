            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white">
                  Kp. Kebon Kalapa RT:03/RW:01 <br /> Rajapolah - Tasikmalaya{" "}
                  <br />
                  Kode Pos : 46155
                </address>
                <a
                  href="tel:+62 81311713953"
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}. Powered By Asep Zarkasih Noor
              </p>
            </div>
          </div>
        </div>
